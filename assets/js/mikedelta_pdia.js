  ...
  Drupal.behaviors.mikedeltaPdia = {
    attach: function (context, settings) {
      ...
      elements.forEach(function (container) {
        ...
        // Definindo a "Data de Hoje" absoluta (Para o Ponto 2)
        ...
        function renderCalendar() {
          ...
          for (let day = 1; day <= daysInMonth; day++) {
            ...
            // Ponto 2: Verifica se o dia renderizado é o dia exato de hoje
            const classeAtual = dateStr === stringHoje ? " dia-atual" : "";
            dayDiv.className = `pdia-day${classeAtual}`;

            // Ponto 1 e 3: Span do número e Div do conteúdo separados
            dayDiv.innerHTML = `
              <span class="dia-numero">${day}</span>
              <div class="conteudo-celula"></div>
            `;
            ...
            if (arquivos[dateStr]) {
              ...
              const renderIcon = iconePdf
                ? `<img src="${iconePdf}" class="pdf-pdia-icon" alt="PDF">`
                : "📄";
              conteudoDiv.innerHTML += renderIcon; // Ícone inserido na div flexível
        ...
        document
          .querySelector("#pdia-prev-year")
          ?.addEventListener("click", () => {
            currentDate.setFullYear(currentDate.getFullYear() - 1);
            renderCalendar();
          });
        document
          .querySelector("#pdia-next-year")
          ?.addEventListener("click", () => {
            currentDate.setFullYear(currentDate.getFullYear() + 1);
            renderCalendar();
          });
        document
          .querySelector("#pdia-prev-month")
          ?.addEventListener("click", () => {
            currentDate.setMonth(currentDate.getMonth() - 1);
            renderCalendar();
          });
        document
          .querySelector("#pdia-next-month")
          ?.addEventListener("click", () => {
            currentDate.setMonth(currentDate.getMonth() + 1);
            renderCalendar();
          });
        ...
        // Ponto 4: Lógica de Imagem de Fundo Aleatória
        const pdiaContainer = document.querySelector(".pdia-container");
        if (pdiaContainer && !pdiaContainer.dataset.bgSet) {
          const imagensFundo = [
            "/modules/mikedelta_pdia/assets/images/wall_0001.jpg",
            "/modules/mikedelta_pdia/assets/images/wall_0002.jpg",
            "/modules/mikedelta_pdia/assets/images/wall_0003.jpg",
            "/modules/mikedelta_pdia/assets/images/wall_0004.jpg",
            "/modules/mikedelta_pdia/assets/images/wall_0005.jpg",
            "/modules/mikedelta_pdia/assets/images/wall_0006.jpg",
            "/modules/mikedelta_pdia/assets/images/wall_0007.jpg",
            "/modules/mikedelta_pdia/assets/images/wall_0008.jpg",
          ];
